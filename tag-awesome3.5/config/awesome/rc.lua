...
for s = 1, screen.count() do
    ...
    batwidget:set_border_color("#BBBBBB")
    batwidget:set_color(
    {
        type = "linear", from = { 0, 0 }, to = { 100, 0 },
        stops = { { 0, "#FF5656" }, { 0.5, "#88A175" }, { 1, "#AECF96" } }
    })
    battxt = wibox.widget.textbox()

    vicious.register(batwidget, vicious.widgets.bat, "$2", 61, "BAT0")
    vicious.register(battxt, vicious.widgets.bat, " $2% ", 61, "BAT0")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Mod1", "Control"    }, "l", function () awful.util.spawn_with_shell("xscreensaver-command -lock > /dev/null") end),
